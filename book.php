...
if (isset($_POST['send'])) {
   ...
   $insert_book->errorInfo();

   //$insert_book = $conn->prepare("INSERT INTO `book_form`(id, name, email, phone, address, location, guests, arrivals, leaving) VALUES('asd','asdasd','asdas.asda@sadasdasd.com',343434,'lololo','asd','2001-11-11','2001-11-11')");
   ...
   <section class="footer">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <a href="#"> <i class="fas fa-map"></i> vellore, tamil nadu - 632014 </a>
         </div>
